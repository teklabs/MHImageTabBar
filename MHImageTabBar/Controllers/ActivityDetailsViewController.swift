...
let kActivityCellInsetWidth: CGFloat = 0.0

class ActivityDetailsViewController : PFQueryTableViewController, UITextFieldDelegate, PhotoDetailsHeaderViewDelegate, BaseTextCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Set table footer
        let footerView = ActivityDetailsFooterView(frame: ActivityDetailsFooterView.rectForView())
    ...
    override func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        if indexPath.row < self.objects!.count { // A comment row
            ...
            if object != nil {
                ...
                return ActivityCell.heightForCellWithName(nameString, contentString: commentString, cellInsetWidth: kActivityCellInsetWidth)
            }
        }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath, object: PFObject?) -> PFTableViewCell? {
        ...
        if cell == nil {
            ...
            cell!.cellInsetWidth = kActivityCellInsetWidth
            cell!.delegate = self
        }
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        ...
        if trimmedComment.characters.count != 0 && self.photo!.objectForKey(kPhotoUserKey) != nil {
            ...
            comment.saveEventually { (succeeded, error) in
                ...
                NSNotificationCenter.defaultCenter().postNotificationName(ActivityDetailsViewControllerUserCommentedOnPhotoNotification, object: self.photo!, userInfo: ["comments": self.objects!.count + 1])
    ...
    // MARK:- ActivityDetailsHeaderViewDelegate
    ...
    func shouldDeletePhoto() {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName(ActivityDetailsViewControllerUserDeletedPhotoNotification, object: self.photo!.objectId)
        self.navigationController!.popViewControllerAnimated(true)
    }
}
