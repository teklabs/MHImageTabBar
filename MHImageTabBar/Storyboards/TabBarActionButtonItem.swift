...
public typealias TabBarActionButtonItemAction = (TabBarActionButtonItem) -> Void

public class TabBarActionButtonItem: NSObject {
    
    /// The action the item should perform when tapped
    public var action: TabBarActionButtonItemAction?
