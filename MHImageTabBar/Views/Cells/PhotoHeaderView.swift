...
@objc protocol PAPPhotoHeaderViewDelegate: NSObjectProtocol {
     ...
     */
    optional func photoHeaderView(photoHeaderView: PhotoHeaderView, didTapUserButton button: UIButton, user: PFUser)
     ...
     */
    optional func photoHeaderView(photoHeaderView: PhotoHeaderView, didTapLikePhotoButton button: UIButton, photo: PFObject)
     ...
     */
    optional func photoHeaderView(photoHeaderView: PhotoHeaderView, didTapCommentOnPhotoButton buton: UIButton, photo: PFObject)
}