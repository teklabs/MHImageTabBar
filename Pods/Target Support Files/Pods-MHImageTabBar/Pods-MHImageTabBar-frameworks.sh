...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-MHImageTabBar/FacebookSDK.framework"
  install_framework "Pods-MHImageTabBar/FormatterKit.framework"
  install_framework "Pods-MHImageTabBar/IOStickyHeader.framework"
  install_framework "Pods-MHImageTabBar/MBProgressHUD.framework"
  install_framework "Pods-MHImageTabBar/Parse.framework"
  install_framework "Pods-MHImageTabBar/ParseCrashReporting.framework"
  install_framework "Pods-MHImageTabBar/ParseFacebookUtils.framework"
